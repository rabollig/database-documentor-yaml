...
INSERT INTO `indexer_state` VALUES (1,'design_config_grid','invalid','2022-10-17 17:02:02','e3e5bf200cd71406045ea520bc0c063f'),(2,'customer_grid','invalid','2022-10-17 17:02:02','cde8d1c78a23ae6462fa1117ff386033'),(3,'catalog_category_product','invalid','2022-10-17 17:02:02','b7569daab5dbb83e83b6683d63d25335'),(4,'catalog_product_category','invalid','2022-10-17 17:02:02','5a72552a92c4865038751cfd420c7315'),(5,'catalogrule_rule','invalid','2022-10-17 17:02:02','1fb66e87de187605884c070d99ee1556'),(6,'catalog_product_attribute','invalid','2022-10-17 17:02:02','82adcd440c18345cac3088739342a5e0'),(7,'cataloginventory_stock','invalid','2022-10-17 17:02:02','b2cb098550f5d456dc828fb176e7a57a'),(8,'catalog_product_price','invalid','2022-10-17 17:02:02','faa4b2c83e95e3d56002c9105ae057c3'),(9,'catalogrule_product','invalid','2022-10-17 17:02:02','fede25479de0d87939e5aa27b78c997d'),(10,'catalogsearch_fulltext','invalid','2022-10-17 17:02:02','1d7a8acd042c3513140973b211e584b5');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COMMENT='List of data/schema patches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `patch_list` VALUES (1,'Magento\\Store\\Setup\\Patch\\Schema\\InitializeStoresAndWebsites'),(2,'Magento\\Catalog\\Setup\\Patch\\Schema\\EnableSegmentation'),(3,'Magento\\Bundle\\Setup\\Patch\\Schema\\UpdateBundleRelatedSchema'),(4,'Magento\\Review\\Setup\\Patch\\Schema\\AddUniqueConstraintToReviewEntitySummary');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb3 COMMENT='Table storing unique queues';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `queue` VALUES (12,'async.operations.all'),(7,'codegenerator'),(3,'export'),(4,'media.content.synchronization'),(5,'media.gallery.renditions.update'),(6,'media.gallery.synchronization'),(11,'media.storage.catalog.image.resize'),(1,'product_action_attribute.update'),(2,'product_action_attribute.website.update'),(10,'product_alert.queue'),(9,'sales.rule.quote.trigger.recollect'),(8,'sales.rule.update.coupon.usage');
...
INSERT INTO `store_group` VALUES (0,0,'Default',0,0,NULL),(1,1,'Main Website Store',2,1,NULL);
...
-- Dump completed on 2022-10-20 16:47:37
